		...
		*/
		addState: function(statename, stateobj, afterState) {
			...
			for(i=0, l=buttons.length; i<l; i++){
				...
				state += '" name="' + opts.prefix + '_' + statename + '_button' + v.title.replace(/[^a-z0-9]+/gi,'');
				state += '" id="' + opts.prefix + '_' + statename + '_button' + v.title.replace(/[^a-z0-9]+/gi,'');
				state += '" value="' + v.value + '">' + v.title + '</button>';
			}
